...
/// @title VaultBenqiLiqStakeLPLibrary for core functions of VaultBenqiLiqStakeLP vaults
library VaultBenqiLiqStakeLPLibrary {
    /* Libs */
    ...
    function liquidStake(
        ...
        // Call deposit func
        IStakedAvax(_liqStakeToken).submit{value: _amount}();
    }
    ...
    function exchangeUSDForWantToken(
        ...
        liquidStake(_token0Bal, _params.token0Address, _params.liquidStakeToken);
        ...
        returns (uint256 returnedUSD)
    {
        ...
        uint256 _synthTokenBal = IERC20Upgradeable(_params.liquidStakeToken).balanceOf(address(this));
        liquidUnstake(
            _params.uniRouterAddress, 
            SafeSwapParams({
        ...
        // Return USD amount
        returnedUSD = IERC20Upgradeable(_params.stablecoin).balanceOf(address(this));
        IERC20Upgradeable(_params.stablecoin).safeTransfer(msg.sender, returnedUSD);
    }
}
